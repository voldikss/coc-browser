...
const provider_1 = __webpack_require__(7);
const util_1 = __webpack_require__(5);
const server_1 = __importDefault(__webpack_require__(2));
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        const config = coc_nvim_1.workspace.getConfiguration('coc.browser');
        ...
        if (capacity <= 0 || capacity >= 10)
            capacity = 5;
        const server = new server_1.default(capacity, storagePath);
        yield server.start();
        const browserCompletionProvider = new provider_1.BrowserCompletionProvider(server);
...
Object.defineProperty(exports, "__esModule", { value: true });
const http_1 = __importDefault(__webpack_require__(4));
const path_1 = __importDefault(__webpack_require__(18));
const coc_nvim_1 = __webpack_require__(1);
const util_1 = __webpack_require__(5);
class Server {
    constructor(capacity, sourceDir) {
...
const progress = __webpack_require__(35);
var Proposed;
(function (Proposed) {
